...
class CrmExecuteSoap {
	 ...
	 *        	The CRM URL.
	 */
	public function SendCreateSOAPRequest($authHeader, $request, $url) {
		$url = rtrim ( $url, "/" );
		$xml = "<s:Envelope xmlns:s=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:a=\"http://www.w3.org/2005/08/addressing\">";
		$xml .= $authHeader->CreateHeader;
		$xml .= $request;
		$xml .= "</s:Envelope>";
